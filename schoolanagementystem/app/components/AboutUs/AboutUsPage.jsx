  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        <h1>About SDRS School of Excellence</h1>
      ...
      <div className={styles.contentContainer}>
        ...
        <div className={styles.mainContent}>
          <section id="history" className={styles.section}>
            ...
            <div className={styles.content}>
              <div className={styles.text}>
                ...
                <p>While we may be new, our educational philosophy is built on time-tested principles of excellence, integrity, and innovation. We are committed to establishing SDRS School of Excellence as a benchmark for quality education in the region.</p>
              </div>
          ...
          <section id="principal" className={styles.section}>
            ...
            <div className={styles.content}>
              ...
              <div className={styles.text}>
                ...
                <p>It is with great excitement that I welcome you to SDRS School of Excellence, a new chapter in educational excellence opening in April 2026. As we prepare to embark on this remarkable journey, I am filled with anticipation for the incredible learning community we are building together.</p>
          ...
          <section id="accreditation" className={styles.section}>
            ...
            <div className={styles.content}>
              <p>SDRS School of Excellence is in the process of securing accreditation from leading educational bodies to ensure we meet the highest standards of educational excellence from our opening in April 2026.</p>
